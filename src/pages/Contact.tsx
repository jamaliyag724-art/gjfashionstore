  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with GJ Fashion. Contact our customer support team for orders, returns, or any questions about our fashion collection."
        />
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">support@gjfashion.com</p>
                    </div>
                  </div>
